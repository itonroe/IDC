...
namespace C20_Ex01_Roe_313510489_Omer_206126138.Classes
{
    public class Player : Ship
    {
        ...
        private void DrawLives(SpriteBatch i_spriteBatch)
        {
            ...
            {
                Point positionForLifes = new Point(i_spriteBatch.GraphicsDevice.Viewport.Width - i * base.Texture.Width/2, base.Texture.Height/2 *(m_PlayerNumber - 1));
                Point scale = new Point(base.Texture.Width/2, base.Texture.Height / 2);
                Rectangle rectangle = new Rectangle(positionForLifes, scale);
                 i_spriteBatch.Draw(base.Texture, rectangle, Color.White * 0.5f);
            }
        }
