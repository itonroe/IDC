...
namespace B20_Ex05
{
    ...
    public class FormSettings : Form
    {
        ...
        private void initializeComponents()
        {
            ...
            m_LabelBoardSize.Top = marginBorders + m_LabelPlayerName2.Bottom;
        ...
        void FormSettings_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show("You must enter names.", "Error");
                e.Cancel = true;
            }
        }

        private bool gameSettingsValid()
        {
            return !m_TextBoxPlayerName1.Text.Equals(string.Empty) && !m_TextBoxPlayerName2.Text.Equals(string.Empty);
        }
    }
    ...
    public class FormGame : Form
    {
        ...
        private void initializeComponents()
        {
            ...
            m_LabelPlayer1Score.Text = $"{m_Game.Player1_Name}: {m_Game.Player1_Score}";
            ...
            m_LabelPlayer2Score.Text = $"{m_Game.Player2_Name}: {m_Game.Player2_Score}";
        ...
        void buttonCard_Click(object sender, EventArgs e)
        {
            ...
            string selectedCard = (char)('A' + i) + (j + 1).ToString();
